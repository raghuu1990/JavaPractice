...
public class AdjacencyList {
	...
	public void addEdge(int startVertex, int endVertex, int weight) {
		adjacencyList[startVertex].add(new Pair<Integer, Integer>(endVertex + 1, weight));
	}
	...
	public LinkedList<Pair> getEdgesFromVertex(int startVertex) {
		LinkedList<Pair> edgeList = (LinkedList<Pair>) new LinkedList(adjacencyList[startVertex]);
		return edgeList;
	}
	...
	public boolean removeEdge(int startVertex, Pair edge) {
